...
test <- read_delim("./UCI HAR Dataset/test/X_test.txt", col_names = F, delim = " ", col_types = list(.default = col_number()))
test_activities <- read_delim("./UCI HAR Dataset/test/y_test.txt", col_names = F, delim = " ")
test_subjects <- read_delim("./UCI HAR Dataset/test/subject_test.txt", col_names = F, delim = " ")
test <- cbind(test_subjects, test_activities,test)

train <- read_delim("./UCI HAR Dataset/train/X_train.txt", col_names = F, delim = " ", col_types = list(.default = col_number()))
train_activities <- read_delim("./UCI HAR Dataset/train/y_train.txt", col_names = F, delim = " ")
train_subjects <- read_delim("./UCI HAR Dataset/train/subject_train.txt", col_names = F, delim = " ")
...
headers <- read_delim("./UCI HAR Dataset/features.txt", col_names=F, delim=" ")[,2]
...
activity_labels <- read_delim("./UCI HAR Dataset/activity_labels.txt", col_names = F, delim=" ")
...
write.table(final_tidy_tibble, "./UCI HAR Dataset/final_tidy_table.txt", row.names = F)
## Thanks!
